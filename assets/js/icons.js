...
const ICONS = {
  ...
  card: `<rect x="1" y="4" width="22" height="16" rx="2.5" ry="2.5"/><line x1="1" y1="9" x2="23" y2="9"/>`,
  download: `<path d="M21 14.5v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/>`,
  piggy: `<circle cx="12" cy="12" r="9"/><path d="M9 9.8c0-1.2 1.2-2.2 3-2.2s3 .9 3 2c0 1.2-1.2 1.6-3 2.2s-3 1-3 2.2c0 1.1 1.2 2 3 2s3-1 3-2.2"/>`,
...
function icon(name, extraClass) {
  ...
  return `<svg class="svg-icon ${extraClass || ''}" viewBox="0 0 24 24">${body}</svg>`;
}
